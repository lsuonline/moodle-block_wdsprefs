...
require_once($CFG->dirroot . '/blocks/wdsprefs/classes/lib.php');

abstract class blocks_wds_profile_field_helper {
    ...
    public static function get_category() {
        ...
        $catid = get_config('block_wdsprefs', 'user_field_catid');
        ...
        if (!$category = $DB->get_record('user_info_category', $params)) {
            ...
            $category->name = get_string('user_info_category', 'block_wdsprefs');
    ...
    public static function default_profile_field($params) {
        ...
        if (!$field = $DB->get_record('user_info_field', $params)) {
            ...
            $field->name = get_string($field->shortname, 'block_wdsprefs');
            $field->description = get_string('auto_field_desc', 'block_wdsprefs');
