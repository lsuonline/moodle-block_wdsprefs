...
abstract class wds_dalo_helpers {
...
abstract class wds_dalo_filter_builder implements IteratorAggregate {
    protected $fields;
    protected $current;
...
class wds_dalo_filter extends wds_dalo_filter_builder {
    public function create_field($field) {
        return new wds_dalo_field($field);
    }
}

class wds_dalo_field extends wds_dalo_helpers implements wds_dalo_dsl_words {
    protected $field;
    protected $aliased;
    protected $built;
