...
class wds_error extends wds_external implements wds_error_types {
    public $name;
    public $params;
    public $timestamp;
    ...
    public function handle($enrollment) {
        ...
        switch ($this->name) {
            case self::COURSE:
                $semester = wds_semester::get(array('id' => $params['semesterid']));
            ...
            case self::DEPARTMENT:
                ...
                $sections = wds_section::get_all(wds::where()->id->in($ids));
                ...
                break;
            case self::SECTION:
                $section = wds_section::get(array('id' => $params['sectionid']));
