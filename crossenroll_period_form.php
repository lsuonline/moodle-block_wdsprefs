...
class crossenroll_period_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('header',
            'wdsprefs:targetperiod',
            get_string('wdsprefs:targetperiod', 'block_wdsprefs'));

        // Instructions.
        $mform->addElement('html',
            '<div class="alert alert-info"><p>' .
            get_string('wdsprefs:crossenrollinstructions1', 'block_wdsprefs') .
            '</p></div>'
        );
